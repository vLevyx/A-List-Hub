...
const VEHICLE_CATEGORIES = {
  ...
  specialty: ["Laboratory", "Fuel", "Banana", "Parcel"],
...
const VEHICLES: Vehicle[] = [
  ...
  },
  {
    ...
    colors:
      "Olive, Camo, Black, Blue, Brown, Green, Khaki, Orange, Pink, Red, White, Yellow",
    whereToBuy: "Car Shops (Main Towns)",
  ...
  },
  {
    ...
    usage:
      "American Fuel Truck. Used for Fuel and Polyester refining. NOTE: American trucks CANNOT be lock picked.",
  },
  {
    ...
    colors:
      "Olive, Camo, Black, Blue, Brown, Green, Khaki, Orange, Red, White, Yellow",
    whereToBuy: "Truck Shops (Main Towns)",
    usage:
      "Bulk personel or item transport. NOTE: American trucks CANNOT be lock picked.",
  },
  {
    ...
    whereToBuy: "Truck Shops (Main Towns)",
    usage:
      "Bulk personel or item transport, comes with a canopy for better concealment. NOTE: American trucks CANNOT be lock picked.",
  },
  {
    name: "Pickup Truck",
    price: 500000,
  ...
  },
  {
    ...
    whereToBuy: "Truck Shops (Main Towns)",
    usage:
      "Large-scale Fuel Truck. Used for Fuel and Polyester refining. NOTE: Russian trucks CAN be lock picked.",
  },
  {
    ...
    whereToBuy: "Truck Shops (Main Towns)",
    usage:
      "Large-scale / Bulk personel or item transport. NOTE: Russian trucks CAN be lock picked.",
  },
  {
    ...
    whereToBuy: "Truck Shops (Main Towns)",
    usage:
      "Large-scale / Bulk personel or item transport, comes with a canopy for better concealment. NOTE: Russian trucks CAN be lock picked.",
  },
  {
    name: "VW Rolf",
    price: 800000,
    ...
    usage:
      "Stylish personal vehicle, quick car to get from point A to point B.",
  },
  {
    name: "S105 Car",
    price: 85000,
    ...
    colors:
      "Light Blue, Tan, Dark Blue, Brown, Dark Red, Green, Olive, Red, White, Yellow",
  ...
  },
  {
    ...
    price: 380000,
    parcels: 8,
    photo: "/images/ParcelVan.png",
    colors: "Red, Blue, Brown, Yellow, Khaki",
    whereToBuy: "Parcel Depot - Saint Pierre",
    usage: "Parcel delivery vehicle",
  },
  {
    ...
    usage:
      "Russian High-capacity air transport. Holds: 3 Pilots - 13 Passengers",
  },
  {
    ...
    whereToBuy: "Only obtainable through crafting",
    usage:
      "United States Tactical helicopter mobility. Holds: 2 Pilots - 10 Passengers",
  },
];
...
export default function VehicleOverviewPage() {
  ...
  const getResourceDisplay = useCallback((vehicle: Vehicle): string => {
    ...
    if (vehicle.parcels) return `${vehicle.parcels} Parcels`;
  ...
  const filteredAndSortedVehicles = useMemo(() => {
    ...
    const sorted = [...filtered].sort((a, b) => {
      switch (sortOption) {
        ...
        case "resources":
          const aRes = a.ores || a.Canisters || a.honeycombs || a.parcels || 0;
          const bRes = b.ores || b.Canisters || b.honeycombs || b.parcels || 0; 
          return bRes - aRes;
        default:
          return 0;
      }
    ...
    const handleScroll = () => {
      ...
      if (currentScrollY > heroSectionHeight) {
        if (
          ...
          currentScrollY > heroSectionHeight + 100
        ) {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-[#0a0a0a] via-[#121212] to-[#1a1a1a] text-[#f0f0f0]">
        ...
        <div className="relative max-w-7xl mx-auto px-4 py-16">
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-6 mb-12">
            ...
            <div className="bg-white/5 backdrop-blur-xl border border-white/10 rounded-2xl p-6 text-center group hover:bg-white/10 transition-all">
              ...
              <div className="text-2xl font-bold text-[#00c6ff] mb-1">
                {formatPrice(vehicleStats.entryPrice)}
              </div>
      ...
      <div
        className={`sticky top-0 z-40 bg-[#121212]/80 backdrop-blur-xl border-b border-white/10 transition-transform duration-300 ease-in-out ${
                ...
                <div className="p-6">
                  ...
                  <div className="flex items-center justify-between mb-3">
                    ...
                    <div className="flex gap-1">
                      {vehicle.name.toLowerCase().includes("helicopter") && (
      ...
      {isDetailPanelOpen && selectedVehicle && (
        <>
          ...
          {/* Detail Panel */}
          <div
            className={`fixed top-0 right-0 h-full w-full max-w-2xl bg-[#0a0a0a]/95 backdrop-blur-2xl border-l border-white/20 z-50 transform transition-transform duration-500 ease-out overflow-y-auto ${
              ...
              <div className="space-y-6">
                ...
                <div className="bg-gradient-to-r from-white/5 to-white/10 rounded-xl p-6 border border-white/10">
                  ...
                  <div className="space-y-3">
                    ...
                    {selectedVehicle.parcels && (
                      <div className="flex justify-between items-center">
                        <span className="text-white/70">Parcels</span>
                        <span className="text-[#00c6ff] font-semibold">{selectedVehicle.parcels}</span>
                      </div>
                    )}
